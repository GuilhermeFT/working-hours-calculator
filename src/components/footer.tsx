...
export default function Footer() {
  return (
    <footer className="mt-16 pt-8 pb-8 text-center border-t border-secondary/10">
      <div className="flex flex-col items-center gap-4">
        <svg width="40" height="41" viewBox="0 0 560 576" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
